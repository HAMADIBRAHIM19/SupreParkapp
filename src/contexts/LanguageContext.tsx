...
const translations = {
  ar: {
    ...
    cancellationsLog: "الطلبات الملغاة والاستردادات",
    noCancelledBookings: "لا توجد طلبات ملغاة",
    cancelledByLabel: "تم الإلغاء بواسطة",
    cancelledByCrewLabel: "الطاقم",
    cancelledBySeekerLabel: "طالب الموقف",
  ...
  en: {
    ...
    cancellationsLog: "Cancelled bookings & refunds",
    noCancelledBookings: "No cancelled bookings",
    cancelledByLabel: "Cancelled by",
    cancelledByCrewLabel: "Crew",
    cancelledBySeekerLabel: "Spot requester",
