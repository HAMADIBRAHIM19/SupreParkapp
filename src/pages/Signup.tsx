...
import { Car, UserPlus, Eye, EyeOff, Search, Users, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-8" dir="rtl">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-4">
          ...
          <CardDescription>انضم إلى Parklet واحجز موقفك بسهولة</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                >
                  ...
                  <span className="text-sm font-semibold text-center">أبحث عن موقف</span>
                </Label>

                <Label
                  htmlFor="crew"
                  className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 cursor-pointer transition-all ${
                    formData.accountType === "crew"
                      ? "border-primary bg-primary/5"
                      : "border-border hover:border-primary/40"
                  }`}
                >
                  ...
                  <span className="text-sm font-semibold text-center">أحد أفراد الطاقم</span>
                </Label>
              </RadioGroup>
            </div>
